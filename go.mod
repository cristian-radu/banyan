module github.com/cristian-radu/banyan
...
require (
	...
	k8s.io/apiserver v0.0.0-20190731143853-d3da6d30e334 // indirect
	k8s.io/client-go v0.0.0-20190731143132-de47f833b8db
	k8s.io/code-generator v0.0.0-20190731142644-68819053f471 // indirect
	k8s.io/klog v0.3.3
